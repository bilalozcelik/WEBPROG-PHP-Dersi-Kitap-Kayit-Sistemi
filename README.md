...
6.  **Admin Yönetimi (admin_kullanicilar.php):** Sistemdeki kullanıcıların yönetildiği admin alanı.
...
5.  Tarayıcıda `http://localhost/kitap_sistemi/login.php` adresini açın.
